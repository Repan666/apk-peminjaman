...
<div class="mb-4">
    ...
    <h2 class="fw-bold text-slate-900">Edit Kategori</h2>
</div>
            ...
            <form method="post" action="<?= base_url('admin/kategori/update/'.$kategori['id']) ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nama_kategori" 
                           ...
                           class="form-control border-light-subtle rounded-3 p-2 px-3" required>
                </div>

                <div class="mb-4">
                    <label class="form-label fw-600 small text-muted">Deskripsi</label>
                    <textarea name="deskripsi" class="form-control border-light-subtle rounded-3" 
                              rows="4"><?= $kategori['deskripsi'] ?></textarea>
                </div>

                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-emerald px-4 rounded-3 shadow-sm">Update Kategori</button>
